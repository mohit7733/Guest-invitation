...
export default function ScanPage() {
  ...
  const startScanner = () => {
    ...
    // Dynamic scanner configuration based on screen size
    const scannerConfig = {
      qrbox: {
        width: viewportWidth < 480 ? 200 : 250,
        height: viewportWidth < 480 ? 200 : 250
      },
      fps: 30,
      aspectRatio: 1.0,
      disableFlip: false,
      showTorchButtonIfSupported: true,
      showZoomSliderIfSupported: viewportWidth > 480,
      defaultZoomValueIfSupported: viewportWidth < 480 ? 1 : 2,
    };
  ...
  }, [eventId, scanResult, isScanning, viewportWidth]);
  ...
  return (
    <div style={{
      ...
      padding: isMobile ? '0' : '20px 16px 40px 16px',
      ...
      <div style={{
        ...
        <div style={{
          ...
          padding: isSmallMobile ? '20px 16px' : isMobile ? '24px 16px' : '28px 24px',
          textAlign: 'center',
          color: '#FFFFFF',
          position: 'relative'
        }}>
        ...
        <div style={{
        ...
        }} className={isSmallMobile ? 'mobile-tiny-padding' : ''}>
          {/* Scanner Area */}
          {!scanResult && (
            <>
              <div style={{ marginBottom: '20px', position: 'relative' }}>
                <div
                  ...
                  style={{
                    ...
                    overflow: 'hidden',
                    border: isMobile ? '2px solid #FFFFFF' : '4px solid #FFFFFF',
          ...
          {/* Guest Details Card */}
          {scanResult && (
            <div className={`animate-slide-up ${isMobile ? 'mobile-stack' : ''}`} style={{
              background: '#FFFFFF',
